...
# Create a Blueprint named 'auth' to organize and modularize your authentication routes
    ...
    if request.method == 'POST':
        ...
        if len(email) < 4:
            ...
            new_user = User(email=email, first_name=first_name,
                            ...
                            min_wave_height=min_wave_height, max_wave_height=max_wave_height,
                            max_wind_mph=max_wind_mph, min_water_temp=min_water_temp)
